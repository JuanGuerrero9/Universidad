...
urlpatterns = [
    ...
    path('recibo/<recibo>/', Recibo.as_view(), name= 'recibo'),
    path('datos_crear_usuario/', DatosCrearUsuario.as_view(), name='datos_crear_usuario'),
    path('usuario_creado/<usuario>/<password>', UsuarioNuevo.as_view(), name='usuario_creado'),
    path('matricular_asignaturas/', MatricularAsignatura.as_view(), name= 'matricular_asignaturas'),
    path('elegir_horario/<asignatura>/', ElegirHorario.as_view(), name= 'elegir_horario'),
